...
[data-testid="collapsedControl"] {
    ...
    box-shadow: 0 0 20px rgba(100, 255, 218, 0.1) !important;
...
/* Hide the default Streamlit chevron icon, use custom */
...
/* ── Force sidebar toggle to ALWAYS show ──────────── */
/* This is the nuclear option — overrides Streamlit's hide logic */
